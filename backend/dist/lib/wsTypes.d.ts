...
export type ClientEventType = "PLAY" | "PAUSE" | "SEEK" | "NEXT" | "PREVIOUS" | "SET_SONG" | "PLAYLIST_ADD" | "PLAYLIST_REMOVE" | "PLAYLIST_REORDER" | "CHAT_MESSAGE";
...
export type ServerEventType = "ROOM_STATE" | "PLAY" | "PAUSE" | "SEEK" | "NEXT" | "PREVIOUS" | "PLAYLIST_ADD" | "PLAYLIST_REMOVE" | "PLAYLIST_REORDER" | "CHAT_MESSAGE" | "USER_JOINED" | "USER_LEFT" | "HOST_CHANGED" | "ROOM_CLOSED" | "JOIN_REQUEST" | "JOIN_REQUEST_RESOLVED" | "ERROR";
...
export type WsErrorCode = "INVALID_EVENT" | "INVALID_PAYLOAD" | "MISSING_PARTICIPANT" | "PARTICIPANT_NOT_ACTIVE" | "HOST_ONLY" | "ROOM_CLOSED" | "ROOM_NOT_FOUND" | "SONG_NOT_FOUND" | "PLAYLIST_ENTRY_NOT_FOUND" | "SEEK_OUT_OF_RANGE" | "RATE_LIMITED" | "INTERNAL_ERROR";
...
export declare function makeServerEvent<T>(type: ServerEventType, payload: T): ServerEnvelope<T>;
/** Build an ERROR envelope */
export declare function makeErrorEvent(code: WsErrorCode, message: string, requestId?: string): ServerEnvelope<WsErrorPayload>;
